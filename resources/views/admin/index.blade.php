	                ...
	                <div class="carousel-inner">
	                        ...
	                        <div class="fill" style=" background-color:#48c3af;">
	                            <div class="inner-content">
	                                <div class="carousel-img">
	                                    <img src="{{url('images/logo.png')}}" alt="sofa" class="img img-responsive" />
	                                </div>
	                                <div class="carousel-desc">

	                                    <h2>Selamat Datang di Web Sistem Mitra Statistik - Badan Pusat Statistik Kabupaten Magelang</h2>
	                    ...
	                    <div class="item item2">
	                        <div class="fill" style="background-color:#b33f4a;">
	                            <div class="inner-content">
	                                <div class="carousel-img">
	                                    <img src="{{url('images/logo.png')}}" alt="white-sofa" class="img img-responsive" />
	                                </div>
	                                <div class="carousel-desc">
